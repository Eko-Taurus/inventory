	        ...
	        <nav class="row top-nav red darken-2">
	    		<div class="container">
	    			<div class="col offset-l2 nav-wrapper">
	    				...
	    				<a class="page-title">Cari Barang Keluar</a>
	    			</div>
	    		</div>
			</nav>
		                ...
		                <li>
		                	...
		                	<div class="collapsible-body">
		                		<ul>
									...
									<li class="active red darken-4"><a href="barangkeluar.php">Barang Keluar</a></li>
								</ul>
							</div>
		                </li>
					...
					<div class="col s12 m12 l12 card-panel z-depth"> <br>
						<table class="highlight">
							...
							<?php 
			                    ...
			                    $cari = $_POST['cari'];
			                    $sql = "SELECT * FROM barang_keluar WHERE kode_barang LIKE '%$cari%' OR nama_barang LIKE '%$cari%' OR tujuan LIKE '%$cari%' OR tanggal LIKE '%$cari%' OR operator LIKE '%$cari%'";
						...
						<table>
							<tr>
				            	<td colspan='9'>
				            		<a href='barangkeluar.php' class="right waves-effect waves-light btn red darken-2">KEMBALI</a>
				            	</td>
				            </tr>
						</table>
					</div>
