	...
	<div class="row">
				...
				<form action="" method="post" name="form1">
					<div class="col s12 m12 l12 card-panel z-depth"> <br>
						<table class="highlight">
							...
							<tr>
				              <th>NIK</th>
				              <th><input type="text" name="nik" required></th>
				            </tr>
				            <tr>
				              <th>Nama</th>
				            ...
				            <tr>
				              <th>Devisi</th>
				              <th><input type="text" name="divisi" required></th>
				            </tr>
				            <tr>
				              <th>LOKER</th>
				              <th><input type="text" name="loker" required></th>
				            </tr>
				            <tr>
				              <th>Username</th>
        ...
        <?php
          ...
          if(isset($_POST['tambah'])) {
            ...
            $result = mysqli_query($koneksi, "INSERT INTO users(nik,nama,alamat,telepon,divisi,loker,username,password,level) VALUES('$nik','$name','$alamat','$telepon','$divisi','$loker','$username','$password','$level')");
