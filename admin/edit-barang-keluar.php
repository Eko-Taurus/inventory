...
{ 
  ...
  $pengirim=$_POST['tujuan'];
  $tanggal=$_POST['tanggal'];
  $operator=$_POST['operator'];
    
  // update user data
  $result = mysqli_query($koneksi, "UPDATE barang_keluar SET kode_barang='$kode',nama_barang='$name',tanggal='$tanggal',tujuan='$pengirim',operator='$operator' WHERE id=$id");
        ...
        <form action="" method="post" name="form1">
          <div class="col s12 m12 l12 card-panel z-depth"> <br>
            <table class="highlight">
              ...
              <tr> 
                <td>Tujuan</td>
                <td><input type="text" name="tujuan" value=<?php echo $pengirim;?>></td>
              </tr>
              <tr> 
                <td>Petugas</td>
